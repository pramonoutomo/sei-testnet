...
echo "=================================================="
echo -e "\033[0;35m"
echo " Based on KJNodes and some modification by PramonoUtomo :)  ";
echo -e "\e[0m"
echo "=================================================="
...
wget -qO $HOME/.sei/config/genesis.json "https://raw.githubusercontent.com/sei-protocol/testnet/master/sei-incentivized-testnet/genesis.json"
wget -qO $HOME/.sei/config/addrbook.json "https://raw.githubusercontent.com/sei-protocol/testnet/master/sei-incentivized-testnet/addrbook.json"
