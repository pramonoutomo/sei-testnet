<p>Please support me by subscribe to https://youtube.com/c/pramonoutomo :)<br />thanks for <a href="https://kjnodes.com/" target="_blank">KJNodes</a>, this is based on his code, but changing some parameter<br /></p>
<p style="font-size:14px" align="center">
<a href="https://pramonoutomo.com/" target="_blank">Visit my website</a><br>
  I use this server for all my testnet:<br>
<a href="https://Lihat.info/contabo" target="_blank">Contabo</a>, <a href="https://Lihat.info/hetzner" target="_blank">Hetzner</a> and <a href="https://Lihat.info/vultr" target="_blank">Vultr</a> (<a href="https://www.vultr.com/?ref=8980052-8H" target="_blank">click here for $100 trial</a>)
</p>
...
# sei node setup for Incentivized Testnet — atlantic-1
...
## Set up your sei fullnode (automatic)
...
```
wget -O sei.sh https://raw.githubusercontent.com/pramonoutomo/sei-testnet/main/sei-pramonoutomo.sh && chmod +x sei.sh && ./sei.sh
```
